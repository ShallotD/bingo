...
// //     if (!checklist?.submittedToCheckerAt || !checklist?.completionDate) return "N/A";
    
// //     const submitted = dayjs(checklist.submittedToCheckerAt);
// //     const completed = dayjs(checklist.completionDate);
// //     const hours = completed.diff(submitted, 'hour');
...
// //                     <div style={{ fontSize: 20, fontWeight: "bold", color: PRIMARY_BLUE }}>
// //                       {docCount}
// //                     </div>
...
// //                 <Col span={8}>
// //                   <div style={{ textAlign: "center" }}>
// //                     <div style={{ fontSize: 20, fontWeight: "bold", color: SUCCESS_GREEN }}>
// //                       {docCount}
// //                     </div>
...
// //                 <Col span={8}>
// //                   <div style={{ textAlign: "center" }}>
// //                     <div style={{ fontSize: 20, fontWeight: "bold", color: WARNING_ORANGE }}>
...
// //               {/* Tooltip explaining revive functionality */}
// //               <div style={{ marginTop: 12, padding: 8, background: 'white', borderRadius: 6 }}>
// //                 <Text type="secondary" style={{ fontSize: 12 }}>
// //                   <InfoCircleOutlined style={{ marginRight: 4, color: ACCENT_LIME }} />
// //                   <strong>Revive Checklist:</strong> Creates a new checklist from this completed one. 
// //                   Ideal for revolving facilities, follow-up loans, or similar transactions where 
// //                   most documents and customer information can be reused.
// //                 </Text>
// //               </div>
// //             </Card>
// //           </Col>

...
//   const handleRMSelect = (value) => {
//     const selected = rmOptions.find((rm) => rm.value === value);
//     if (selected) setAssignedToRM(selected.id);
//   };
...
//     setCustomerNumber(option.value);
...
import { AutoComplete, Input } from "antd";
import { useGetCustomersQuery } from "../../api/userApi";
// import ChecklistFormFields from "../checker/ChecklistFormFields";

const ChecklistFormCreator = ({
  rms,
  assignedToRM,
  setAssignedToRM,
...
export default ChecklistFormCreator;